...
echo ##############################
%scp% -P %arm32Port% -r "../obf/Apps" "../obf/models" "../obf/3rd-modified" %arm32%:%defFolder%DICE/EncryptionNodeJS
...
echo ##############################
%scp% -P %arm64Port% -r "../obf/Apps" "../obf/models" "../obf/3rd-modified" %arm64%:%defFolder%EncryptionNodeJSSources
